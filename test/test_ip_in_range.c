...
test_ip_cidr_to_in6(void) {
    ...
    // Test that an oversized CIDR value is rejected without integer overflow.
    CU_ASSERT_TRUE(
        ip_cidr_to_in6("::ffff:192.168.1.1/999999999999", &iprange) != 0);
}
...
test_cidr_to_netmask(void) {
    ...
    // ipv6 netmask of /120 as a char array
    const uint8_t expected_netmask[] = {0xff,
                                        0xff,
                                        0xff,
                                        0xff,
                                        0xff,
    ...
    const uint8_t expected_netmask2[] = {0xff,
                                         0xff,
                                         0xff,
                                         0xff,
                                         0xff,
    ...
    const uint8_t expected_netmask3[] = {0x00,
                                         0x00,
                                         0x00,
                                         0x00,
                                         0x00,
    ...
    const uint8_t expected_netmask4[] = {0xff,
                                         0xff,
                                         0xff,
                                         0xff,
                                         0xff,
